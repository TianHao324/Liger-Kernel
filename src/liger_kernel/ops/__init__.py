...
# --- Kernel functions ---
# These are also subject to vendor replacement when imported from this package
from liger_kernel.ops.cross_entropy import cross_entropy_forward, cross_entropy_backward
from liger_kernel.ops.fused_add_rms_norm import fused_add_rms_norm_forward, fused_add_rms_norm_backward
from liger_kernel.ops.fused_linear_cross_entropy import fused_linear_cross_entropy_forward, fused_linear_cross_entropy_backward
from liger_kernel.ops.fused_linear_jsd import fused_linear_jsd_forward, fused_linear_jsd_backward
from liger_kernel.ops.geglu import geglu_forward, geglu_backward
from liger_kernel.ops.group_norm import group_norm_forward, group_norm_backward
from liger_kernel.ops.jsd import jsd_forward, jsd_backward
from liger_kernel.ops.layer_norm import layer_norm_forward, layer_norm_backward
from liger_kernel.ops.poly_norm import poly_norm_forward, poly_norm_backward
...
def _replace_with_vendor_ops():
    ...
    # CUDA (default) uses the default implementations
    if device == "cuda":
        return
